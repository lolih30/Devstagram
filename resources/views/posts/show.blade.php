    ...
    <div class="md:w-1/2 ">
        ...
        <div class="p-3 flex items-center gap-4">
            ...
            <form action=" {{route('posts.likes.destroy', $post)}} " method="POST">
                ...
                <div class="my-4">
                    <button type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-6 h-6">
        ...
        <div>
            ...
            {{-- laravel tiene una api para fechas llamada diffForHumans--}}
            {{-- laravel tiene integrado una libreria que se llama carbon--}}
        ...
        <div class="  shadow bg-white p-5 mb-5">
            ...
            <form action="{{route('comentarios.store', ['post' => $post, 'user'=> $user])}}" method="POST">
                ...
                <div class="mb-5">
                    <Labe for="comentario" class="mb-2 block uppercase text-gray-500 font-bold">
                        ...
                        <textarea id="comentario" name="comentario" placeholder="Agregar un comentario" class="boder p-3 w-full rounded-lg @error('name')border-red-500 @enderror"></textarea>
            ...
            <div class=" bg-white shadow mb-5 max-h-96 overflow-y-scroll mt-10 ">
                ...
                <div class="p-5 border-gray-300 border-b">
                    ...
                    {{-- el comentario se esta almacenando en la columna comentario po eso el ->comentario --}}
