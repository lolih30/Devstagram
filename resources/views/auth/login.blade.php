        ...
        <div class="md:w-4/12  bg-white p-6 rounded-lg shadow-xl">
            ...
            <form action="{{route('login')}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    name="email"
                    type="email"
                    placeholder="Tu nombre email de Registro"
                ...
                <div class="mb-5">
                   <input type="checkbox" name="remenber"> <label class=" text-gray-500 text-sm"> Mantener mi sesion abierta</label>
                </div>
